                                ...
                                <ScrollReveal animation="slideRight" delay={800}>
                                        ...
                                        <div className="space-y-4">
                                                {Object.entries(promotionData.packagePrices).map(([packageType, price]) => (
                                                        <div key={packageType} className="border border-gray-300 rounded-lg p-4 bg-gray-50">
                                                                <div className="flex justify-between items-center">
                                                                        <span className="text-xl font-semibold text-gray-800 capitalize">{packageType}</span>
                                        ...
                                        {promotionData.reviews && (
                                                <div className="mt-8">
                                                        <h3 className="text-2xl font-bold text-gray-800 mb-4">Avaliações</h3>
                                                        <div className="flex items-center mb-4">
                                                                <StarRating rating={promotionData.reviews.averageRating} />
                                                                <span className="ml-2 text-lg text-gray-600">({promotionData.reviews.totalReviews} avaliações)</span>
                                                        </div>
                                                </div>
                                        )}
                                        </div>
